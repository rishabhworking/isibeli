...
1 Use the setup file to install Isibeli GUI Wallet

2 Default Location of Isibeli's root Directory in Windows is:
    
    32-bit: Program Files/Isibeli
    64-bit: Program Files (x86)/Isibeli

3 Go to Isibeli's root directory and run Isibeli-qt.exe

4 Data Directory is located at: Users/your_windows_user/AppData/Roaming/Isibeli
