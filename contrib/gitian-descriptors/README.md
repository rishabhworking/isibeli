...
--Updated 4/5/2014 by IsibeliDevs--
--fixed QT source Links--
--Updated to Isibeli Folders--
--updated links to boost 1_55_0
--Added FAQ--



<img src="http://isibeli.com/splash.png" alt="Isibeli">
...
Once you've got the right hardware and software:
    ...
    https://github.com/IsibeliCoin/isibeli.git
    ...
    cd ../gitian-builder
    git pull
    sudo ./bin/gbuild --commit Isibeli=HEAD ../Isibeli/contrib/gitian-descriptors/gitian.yml

    # Build Win32 dependencies: (only needs to be done once, or when dependency versions change)
    sudo ./bin/gbuild --commit Isibeli=HEAD ../Isibeli/contrib/gitian-descriptors/boost-win32.yml
    sudo ./bin/gbuild --commit Isibeli=HEAD ../Isibeli/contrib/gitian-descriptors/deps-win32.yml
    sudo ./bin/gbuild --commit Isibeli=HEAD ../Isibeli/contrib/gitian-descriptors/qt-win32.yml

    # Build Win32 release:
    sudo ./bin/gbuild --commit Isibeli=HEAD ../Isibeli/contrib/gitian-descriptors/gitian-win32.yml
...
If you need more help please visit Isibeli Forum at www.Isibeli.rocks
